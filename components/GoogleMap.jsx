          ...
          >
            <View style={styles.markerContainer}>
              <Image
                ...
                style={styles.markerImage} // Size of marker image is adjusted here
              />
            </View>
          </Marker>
        ))}
...
const styles = StyleSheet.create({
  ...
  markerContainer: {
    ...
    alignItems: 'center',
    width: 35, // Match the image size
    height: 35, // Match the image size
  },
  markerImage: {
    width: 35, // Set the width of the marker image
    height: 35, // Set the height of the marker image
    resizeMode: 'cover', // You can try 'cover' or 'stretch' if 'contain' doesn't work
  },
});
